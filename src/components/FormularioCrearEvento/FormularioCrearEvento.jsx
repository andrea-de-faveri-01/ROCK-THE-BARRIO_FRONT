    ...
    <div className="card">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div classname="div-input">
          ...
          <input {...register("subtitle", { required: true })} classname="input"/>
          {errors.subtitle && <span>Subtítulo es requerido</span>}
        </div>
        <div classname="div-input">
          <label>Información</label>
          <textarea {...register("content", { required: true })} classname="input"/>
          {errors.content && <span>Contenido es requerido</span>}
        </div>
        <div classname="div-input">
          <label>Lugar</label>
          <input {...register("site", { required: true })} classname="input"/>
          {errors.site && <span>Sitio es requerido</span>}
        </div>
        <div classname="div-input">
          <label>Precio</label>
          <input {...register("price", { required: true })} classname="input"/>
          {errors.price && <span>Precio es requerido</span>}
        </div>
        <div classname="div-input">
          <label>Fecha de Inicio</label>
          <input type="date" {...register("date_start", { required: true })} classname="input"/>
          {errors.date_start && <span>Fecha de Inicio es requerida</span>}
        </div>
        <div classname="div-input">
          <label>Fecha de Fin</label>
          <input type="date" {...register("date_end")} classname="input"/>
        </div>
        <div classname="div-input">
          <label>URL</label>
          <input {...register("url")} />
